...
var getSecondaryDomain = (function  () {
  ...
  //  festival customize
    var start_time = 1524931200, // toolbar 特殊样式起始时间戳
        end_time = 1525190400,  // toolbar 特殊样式结束时间戳
         ...
         * 当前时间在起始与结束时间内时触发
         */
        if(now_time > start_time && now_time<end_time && (getSecondaryDomain === 'www' || getSecondaryDomain === 'feed' || getSecondaryDomain === 'blog' )){
          logo_href = 'https://edu.csdn.net/courses/d1_k?utm_source=home3';
          logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/51.jpg">';
          logo_title = '五一';
          console.log('五一');
        }
...
// 因为 logo 是SVG 的，所以必须把 iconfont.js 加入到代码里面
  ...
  document.write('<script class="toolbar-s" type="text/javascript" src='+protocol+'//csdnimg.cn/cdn/content-toolbar/iconfont.js?_=1234"></script>');
  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix">\
            ...
            <li class="tb_is1260hide"><a href="//download.csdn.net/vip_code" title="VIP" target="_blank">VIP</a></li>\
            <li class="tb_is1320hide"><a href="//huiyi.csdn.net/" title="活动" target="_blank">活动</a></li>\
            <li class="tb_is1380hide"><a href="http://job.csdn.net" title="招聘" target="_blank">招聘</a></li>\
            <li class="tb_is1440hide"><a href="http://www.iteye.com" title="ITeye" target="_blank">ITeye</a></li>\
            ...
            <a href="javascript:;"class="show-more-a"><svg width="22" height="4" xmlns="http://www.w3.org/2000/svg"><path d="M2 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" fill="#4F4F4F" fill-rule="evenodd"/></svg></a>\
              <div class="more">\
                <div class="tb_is1260show"><a href="//download.csdn.net/vip_code" title="VIP" target="_blank">VIP</a></div>\
                <div class="tb_is1320show"><a href="//huiyi.csdn.net/" title="活动" target="_blank">活动</a></div>\
                <div class="tb_is1380show"><a href="http://job.csdn.net" title="招聘" target="_blank">招聘</a></div>\
                <div class="tb_is1440show"><a href="http://www.iteye.com" title="ITeye" target="_blank">ITeye</a></div>\
                <div class="tb_is1440show"><a href="http://www.csto.com" title="CSTO" target="_blank">CSTO</a></div>\
              </div>\
            </li>\
          </ul>\
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="gitChat"><a class="" href="http://gitbook.cn/new/gitchat/activity?utm_source=csdnblog1" target="_blank"><svg class="toolbar-icon" aria-hidden="true"><use xlink:href="#gitchat"></use></svg><span>发Chat</span></a></li>\
              ...
              <li class="userLogin">\
                <div class="loginCenter"><a href="//my.csdn.net" target="_blank"><img class="login_img" src="'+currUser.avatar+'"><div class="toolbar-circle"></div></a></div>\
                <div class="userControl">\
                  <div><a href="//blog.csdn.net/'+currUser.userName +'" target="_blank">我的博客</a></div>\
                  <div><a class="xiaoxi" href="http://msg.csdn.net/" target="_blank">消息<span class="toolbar-newsL">(3)</span></a></div>\
                  <div><a href="//my.csdn.net/my/account/changepwd" target="_blank">帐号设置</a></div>\
  ...
  function advert(){
    ...
    function dynamicTpl(options, callback){
      ...
      styl = '<style type="text/css">' +
        '.hide{display:none;}' +
        '.advert-bg{background-color:#10172e;}' +
        '.advert{width: 1200px;margin: 0 auto;position:relative;line-height: 0;font-size: 0;}' +
        '.advert .advert-log{display:inline-block;width:90px;height:22px;background-image: url("//csdnimg.cn/public/publick_img/gitchat_logo.png");background-repeat: no-repeat;background-size: contain;position:absolute;top:25px;left:27px;z-index: 10;}' +
        ...
        '.advert-cur .advert-a{background-image: url("//csdnimg.cn/public/publick_img/dcim01.jpg") !important;opacity:1;}' +
      ...
      '</style>';
      tpl = '<div class="advert-bg"><div class="advert" id="advert"><a href="http://gitbook.cn/gitchat/saleActivity?utm_source=csdndt" class="advert-log"></a><a href="http://gitbook.cn/gitchat/saleActivity?utm_source=csdndt" style="background-image: url(//csdnimg.cn/public/publick_img/dcim02.jpg);" class="advert-a"></a><a href="" class="advert-close" id="js_advert_close">&times</a></div></div>';
